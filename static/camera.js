...
function clickCapture() {
    ...
    tempCanvas.toBlob(function(blob) {
        ...
        newImg.onload = function() {
            ...
            /*
            let mat = cv.imread(newImg);
            console.log("mat = " + mat);
            cv.imshow('canvas-out', mat);
            mat.delete();
            */
    ...
    // TODO: Loading net
    //if( !cv.xmodules.dnn ) {
    //    throw new Error("No dnn modules");
    //}
    //let modelFile = "/home/chieko/Projects/OpenCvJsTextReader/frozen_model/frozen_east_text_detection.pb";
    //let modelFile = "/home/chieko/Projects/OpenCvJsTextReader/aaa.pb";
    /*
    let modelFile = "frozen_east_text_detection.pb";
    ...
    utils.createFileFromUrl(modelFile, modelFile, () => {
        ...
        net = cv.readNet(modelFile);
        console.log("net layers = " + net.getLayerNames());
...
window.onload = async function(){
    document.getElementById('cap').addEventListener('click', clickCapture);
    document.getElementById('camback').addEventListener('click', loadCamera);
    loadCamera();     
